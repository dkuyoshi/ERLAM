...
def main():
    ...
    parser.add_argument('--k', type=int, default=50, help='number of K')
    ...
    args.outdir = experiments.prepare_output_dir(args, args.outdir,
                                                 time_format='{}/{}/%Y%m%dT%H%M%S.%f'.format(args.env, name))
    ...
    if args.dueling:
        q_func = DuelingQFunction(n_actions, dim=args.dim)
    else:
        q_func = QFunction(n_actions, dim=args.dim)
